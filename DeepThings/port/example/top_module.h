...
class artificial_example:sc_core::sc_module
{
 public:
    int NodeID; 
	...
	,data_send_fifo1(QUEUE_SIZE)
	,size_send_fifo1(QUEUE_SIZE)
	,data_recv_fifo1(QUEUE_SIZE)
	,size_recv_fifo1(QUEUE_SIZE)
	,data_send_fifo2(QUEUE_SIZE)
	,size_send_fifo2(QUEUE_SIZE)
	,data_recv_fifo2(QUEUE_SIZE)
    	,size_recv_fifo2(QUEUE_SIZE)
    {
